...
//The function in charge of setting the downs 
function fancy(dwn){
	if (dwn == 1)
	{
		return "1st";
...
var strikes = 0;
var balls = 0;
var out_s = document.getElementById('outs');
var bat_s = document.getElementById('bat');
function set()
{
	out_s.innerHTML = "Outs: " + outs;
	bat_s.innerHTML = "S: " + strikes + " B: " + balls;
}
var out_button = document.getElementById('out');
var strike_button = document.getElementById('strike');
var ball_button = document.getElementById('ball');
...
strike_button.onclick = function()
{
