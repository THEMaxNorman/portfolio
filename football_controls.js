//Max Norman
function rexport(){
    var datta = maxport("q | clock | fb | logo "); 
    alert(datta)
}
...
var down = 1;
var yd_txt = "1st & 10";
var yards = document.getElementById("yds");
var yd_string = document.getElementById("down_c");
var submit = document.getElementById('subm_btn');
var downs = document.getElementById('nextDown');
yards.value = 10;
submit.onclick = function(){
	yd_txt = fancy(down) + " & " + yards.value;
	yd_string.innerHTML = yd_txt;
